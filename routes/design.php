...
use App\Http\Controllers\Designs\LanguageController;
use App\Http\Controllers\Designs\DashboardController;
use App\Http\Controllers\Designs\AppsController;
use App\Http\Controllers\Designs\UserInterfaceController;
use App\Http\Controllers\Designs\CardsController;
use App\Http\Controllers\Designs\ComponentsController;
use App\Http\Controllers\Designs\ExtensionController;
use App\Http\Controllers\Designs\PageLayoutController;
use App\Http\Controllers\Designs\FormsController;
use App\Http\Controllers\Designs\TableController;
use App\Http\Controllers\Designs\PagesController;
use App\Http\Controllers\Designs\MiscellaneousController;
use App\Http\Controllers\Designs\AuthenticationController;
use App\Http\Controllers\Designs\ChartsController;
...
Route::group(['prefix' => 'design'], function () {
    ...
    Route::group(['prefix' => 'auth'], function () {
        ...
        Route::get('forgot-password-v1',
            [AuthenticationController::class, 'forgot_password_v1'])->name('auth-forgot-password-v1');
        Route::get('forgot-password-v2',
            [AuthenticationController::class, 'forgot_password_v2'])->name('auth-forgot-password-v2');
        Route::get('reset-password-v1',
            [AuthenticationController::class, 'reset_password_v1'])->name('auth-reset-password-v1');
        Route::get('reset-password-v2',
            [AuthenticationController::class, 'reset_password_v2'])->name('auth-reset-password-v2');
