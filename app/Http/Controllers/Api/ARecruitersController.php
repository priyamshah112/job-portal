    ...
    public function index()
    {
        return DataTables::of(Recruiter::whereNull('deleted_at')->with('user')->with('package'))
            ->addColumn('action', function ($data) {
                ...
                $menu .= '<a title="View" href="' . route('arecruiters-view', ['id' => $data->user->id]) . '" class="btn p-0 m-0"><i data-feather="eye" class="text-primary ml-1 font-medium-5"></i></a>';
                $menu .= '<a title="Edit" href="' . route('arecruiters-edit', ['id' => $data->user->id]) . '" class="btn p-0 m-0"><i data-feather="edit" class="text-warning ml-1 font-medium-5"></i></a>';
