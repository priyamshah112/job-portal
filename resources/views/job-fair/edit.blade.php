                    ...
                    <div class="row mt-1 mb-2">                                              
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" id="start_time" name="start_time" value="{{$job_fair->start_time}}" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label for="end_time" class="form-label">End Time*</label>
                                <input type="time" class="form-control" id="end_time" name="end_time" value="{{$job_fair->end_time}}" />
                            </div>
                        </div>
                    </div>               
                    <div class="d-flex justify-content-between">
