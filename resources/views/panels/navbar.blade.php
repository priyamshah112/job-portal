                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                ...
                                <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                                        ...
                                        <div class="media d-flex align-items-start">
                                            ...
                                            <div class="media-body">
                                                <p class="media-heading"><span
                                                            class="font-weight-bolder">New Question Answered</span>&nbsp
                                        ...
                                        <div class="media d-flex align-items-start">
                                            ...
                                            <div class="media-body">
                                                <p class="media-heading"><span class="font-weight-bolder">ECG and Pathology </span>&nbsp;check and approve now
                            ...
                            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user"
                               ...
                               aria-expanded="false">
                                <div class="user-nav d-sm-flex d-none">
                                    <span class="user-name font-weight-bolder">{{ \Illuminate\Support\Str::ucfirst(\Illuminate\Support\Facades\Auth::user()->name) }}</span>
                                    {{--<span class="user-status">{{auth()->user()->roles[0]->name}}</span> --}}
                                </div>
                                <span class="avatar">
              <img class="round" src="{{auth()->user()->img_path ? auth()->user()->img_path : asset('images/portrait/small/avatar-s-11.jpg')}}"  alt="avatar" height="40"
                   width="40">
