...
@section('content')
<!-- cateory list start -->
<section class="app-category-list" data-create="{{auth()->user()->hasPermissionTo('create-user')  ? true : false }}" data-write="{{auth()->user()->hasPermissionTo('write-user')  ? true : false }}" data-delete="{{auth()->user()->hasPermissionTo('delete-user')  ? true : false }}">
  <!-- list section start -->
  <div class="card">
