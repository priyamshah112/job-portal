...
@section('content')
<!-- cateory list start -->
<section class="app-category-list" data-create="{{auth()->user()->hasPermissionTo('create-permission')  ? true : false }}" data-write="{{auth()->user()->hasPermissionTo('write-permission')  ? true : false }}" data-delete="{{auth()->user()->hasPermissionTo('delete-permission')  ? true : false }}">
  <!-- list section start -->
  <div class="card">
...
@section('page-script')
  {{-- Page js files --}}
  <script src="{{ asset(mix('js/permission-list.js')) }}"></script>
@endsection