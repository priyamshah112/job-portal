                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="account-name">Name</label><span
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="account-e-mail">E-mail</label><span
                                                    class="invalid-feedback">*</span>
                        ...
                        <div class="tab-pane fade" id="account-vertical-password" role="tabpanel"
                            ...
                            <form class="change-password" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="account-old-password">Old Password</label><span
                                                    class="invalid-feedback">*</span>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="account-new-password">New Password</label><span
                                                    class="invalid-feedback">*</span>
                                            <div class="input-group form-password-toggle input-group-merge">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="account-retype-new-password">Retype New Password</label><span
                                                    class="invalid-feedback">*</span>
                                            <div class="input-group form-password-toggle input-group-merge">
