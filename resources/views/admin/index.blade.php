        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header flex-column align-items-start pb-0">
                    ...
                    <h2 class="font-weight-bolder mt-1">5 <small>Recruiters</small></h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header flex-column align-items-start pb-0">
                    ...
                    <h2 class="font-weight-bolder mt-1">5 <small class="card-text">Created Jobs</small></h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header flex-column align-items-start pb-0">
                    ...
                    <h2 class="font-weight-bolder mt-1">20 <small class="card-text">Total Placement</small></h2>
                </div>
            </div>
        </div>
    </div>
...
@section('page-script')
<!-- Page js files -->
<script data-url="{{route('admin-dashboard')}}" id="pageScript" src="{{ asset('js/admin-dashboard.js') }}"></script>
@endsection
