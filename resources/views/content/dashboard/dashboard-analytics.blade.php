    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="font-weight-bolder mt-1">5</h2>
          <p class="card-text">Courses Uploaded</p>
        </div>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="font-weight-bolder mt-1">20</h2>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="font-weight-bolder mt-1">20</h2>
          <p class="card-text">Courses Purchased</p>
        </div>
        <div id="drafted-chart"></div>
      </div>
    </div>
  </div>
