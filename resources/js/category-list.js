    ...
    var dtCategoryTableInit = dtCategoryTable.DataTable({
      ...
      fnDrawCallback: function() {        
        ...
        $('.formEdit').on('click', function(){         
          ...
          $.ajax({
            url: `${assetPath}api/v1/category/${id}`,
            type: 'GET',
            data: {
              _token: token
            },
            ...
            if (result.value) {
              $.ajax({
                ...
                success: function (res) {
                  ...
                  toastr['warning']('👋 Category Deleted Successfully', 'Deleted!', {
                    closeButton: true,
                    tapToDismiss: false,
                    rtl: isRtl
                  });
  ...
  if (newCategoryForm.length) {
    ...
    newCategoryForm.on('submit', function (e) {
      ...
      if (isValid) {
        ...
        if(editForm){
          $.ajax({
            url: `${assetPath}api/v1/category/${selectedRowDataId}?_method=PUT`,
